function dydt = ODE_Clock_KO_IAV(t, y, par_clock, par_IAV, t_IAV)
    ...
    [beta, k_I, gamma, eta, r, a_MI, a_NI, a_KI, a_TI, ...
        c_IL1b_Mono, c_IL1b_N, c_CCL2_Mono, c_CXCL5_N, c_M_IL1b, c_I_IL1b, ...
        c_M_IL10, c_M_CCL2, c_I_CCL2, c_N_CXCL5, c_I_CXCL5, c_I_K, c_M_T, ...
        K_IL1b_Mono, K_IL1b_N, K_CCL2_Mono, K_CXCL5_N, K_IL10_IL1b, K_IL10_CCL2, K_IL10_CXCL5, ...
        K_I_K, K_T, K_M_T, n_CCL2_Mono, n_CXCL5_N, n_I_K, n_M_T, ...
        d_I, d_V, d_Mono, d_N, d_IL1b, d_IL10, d_CCL2, d_CXCL5, d_K, d_T, b_K, ...
        K_B_M, K_BMAL1_IL1b, K_BMAL1_CCL2, c_P_K, K_P_K, K_REV_V, K_REV_IL1b, K_REV_IL10, ...
...
%     dydt(16) = gamma * I2 - d_V * V - d_Vs * V / (K_V + V);
    dydt(16) = FracNoInf(K_REV_V, K_REV_V + REV) * gamma * I2 - T_E / (T_E + 150) *  d_V * V;
