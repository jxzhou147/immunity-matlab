...
%             a_NH * (N - b_N) * H + d_H * H;
    ...
    if (N < 0)
        ...
        dydt(6) = c_CXCL5_N * FracNoInf(RealRootPromise(CXCL5, n_CXCL5_N), (RealRootPromise(K_CXCL5_N, n_CXCL5_N) + RealRootPromise(CXCL5, n_CXCL5_N))) - ...
            d_N * N;
    end
    ...
    if (K < 0)
        ...
        dydt(11) = c_IK * FracNoInf(RealRootPromise(If, n_IK), (RealRootPromise(K_IK, n_IK) + RealRootPromise(If, n_IK))) + ...
