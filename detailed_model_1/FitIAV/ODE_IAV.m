...
%     dydt(3) = - dydt(1) - dydt(2);
    ...
    dydt(6) = b_N * d_N + c_IN * FracNoInf(RealRootPromise(If, n_IN), (RealRootPromise(K_IN, n_IN) + RealRootPromise(If, n_IN))) + ...
        c_CXCL5_N * FracNoInf(RealRootPromise(CXCL5, n_CXCL5_N), (RealRootPromise(K_CXCL5_N, n_CXCL5_N) + RealRootPromise(CXCL5, n_CXCL5_N))) - ...
        d_N * N;
