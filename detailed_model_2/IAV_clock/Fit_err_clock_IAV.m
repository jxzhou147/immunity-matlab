function err = Fit_err_clock_IAV(data_h, data_m, data_mono, data_neu, data_nk, data_v, data_t, data_te, data_il6, data_ccl2, par_IAV_fixed, parFit)
    ...
    y0 = zeros(26, 1);
    y0(16) = 40;
    y0(13) = par_IAV_fixed(55);
    y0(17) = par_IAV_fixed(56);
    y0(19) = par_IAV_fixed(57);
    y0(24) = par_IAV_fixed(58);
    y0(25) = 10;
    ...
    for i = 1:4
        ...
        err = err + ((y_23(ind_23, 17) - data_m(2, i)) ...
            / max(data_m(2, :))) .^ 2;
        err = err + ((y_23(ind_11, 18) - data_mono(data_ind, i)) ...
            / max(data_mono(data_ind, :))) .^ 2;
        err = err + ((y_23(ind_23, 19) - data_neu(2, i)) ...
            / max(data_neu(2, :))) .^ 2;
        err = err + ((y_23(ind_23, 24) - data_nk(2, i)) ...
            / max(data_nk(2, :))) .^ 2;
    end
    ...
    for i = 1:3
        ...
        err = err + ((y_11(ind_11, 17) - data_m(3, i)) ...
            / max(data_m(3, :))) .^ 2;
        err = err + ((y_11(ind_11, 18) - data_mono(data_ind, i)) ...
            / max(data_mono(data_ind, :))) .^ 2;
        err = err + ((y_11(ind_11, 19) - data_neu(3, i)) ...
            / max(data_neu(3, :))) .^ 2;
        err = err + ((y_11(ind_11, 24) - data_nk(3, i)) ...
            / max(data_nk(3, :))) .^ 2;
    end
...
%             / max(data_t(2, :))) .^ 2;
        err = err + ((y_23(ind_23, 26) - data_te(2, i)) ...
            / max(data_te(2, :))) .^ 2;
        % err of ZT11
%         ind_11 = t == (data_t(1, i) + t_IAV_11);
% %         err = err + ((y_11(ind_11, 24) - data_t(3, i)) ...
% %             / max(data_t(3, :))) .^ 2;
        err = err + ((y_11(ind_11, 26) - data_te(3, i)) ...
            / max(data_te(3, :))) .^ 2;
    end
    ...
    for i = 1:4
        ...
        err = err + ((y_23(ind_23, 20) - data_il6(2, i)) ...
            / max(data_il6(2, :))) .^ 2;
        err = err + ((y_23(ind_23, 22) - data_ccl2(2, i)) ...
            / max(data_ccl2(2, :))) .^ 2;
        % err of ZT11
        ind_11 = t == (data_il6(1, i) + t_IAV_11);
        err = err + ((y_11(ind_11, 20) - data_il6(3, i)) ...
            / max(data_il6(3, :))) .^ 2;
        err = err + ((y_11(ind_11, 22) - data_ccl2(3, i)) ...
            / max(data_ccl2(3, :))) .^ 2;
    end
