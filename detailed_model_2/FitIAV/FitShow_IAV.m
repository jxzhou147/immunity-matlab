...
par_manual = importdata('fitted_par_IAV.txt');
...
plot(tspan, y_11(:, 5) + y_11(:, 6), 'r', 'LineWidth', 2);  hold on;
plot(tspan, y_manual(:, 5) + y_manual(:, 6), 'k', 'LineWidth', 2);  hold on;
...
plot(tspan, y_11(:, 15), 'r', 'LineWidth', 2);  hold on;
plot(tspan, y_manual(:, 15), 'k', 'LineWidth', 2);  hold on;
