function dydt = ODE_IAV(t, y, par_IAV)
    ...
    [beta, gamma, eta, ...
        ...
        c_IL6_M, c_IM, c_CCL2_Mono, c_N, c_CXCL5_N, c_M_IL6, c_K_IL6, c_N_IL6, c_I_IL6, ...
        c_M_IL10, c_M_CCL2, c_I_CCL2, c_M_CXCL5, c_I_CXCL5, c_K, c_MK, c_IK, c_MT, ...
        K_IL6_M, K_MI, K_IL10_IL6, K_IL10_CCL2, K_IL10_CXCL5, K_T, K_MT, n_MT, ...
...
%     dydt(1) = - beta * H * V;
    ...
    dydt(6) = c_CCL2_Mono * CCL2 * (Mono_tot - Mono) - d_Mono * Mono;
    
    dydt(7) = (c_N + c_CXCL5_N * CXCL5) * ((c_N + d_N) / c_N * b_N - N) - d_N * N;
    ...
    dydt(11) = FracNoInf(K_IL10_CXCL5, K_IL10_CXCL5 + IL10) * c_M_CXCL5 * (M + Mono) + ...
        c_I_CXCL5 * If - d_CXCL5 * CXCL5;
    
    dydt(12) = (c_K + c_MK * (M + Mono) + c_IK * If) * ((c_K + d_K) / c_K * b_K - K) - d_K * K;
