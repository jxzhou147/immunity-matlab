...
lb = par_bound.data(1:48, 1);
ub = par_bound.data(1:48, 2);

parFit0 = importdata('proper.txt');
parFit0 = parFit0.data(1:48);
...
options = optimoptions('simulannealbnd','PlotFcns',...
          ...
          'AnnealingFcn', {@newPar}, 'MaxIterations', 2000);
...
par_name = char('beta', 'gamma', 'eta', 'a_MI', 'a_NI', 'a_KI', ...
        'a_TI', 'a_MD', 'a_NV', 'c_IL6_M', 'c_IM', 'c_CCL2_Mono', 'c_N', 'c_CXCL5_N', ...
        'c_M_IL6', 'c_K_IL6', 'c_N_IL6', 'c_I_IL6', 'c_M_IL10', 'c_M_CCL2', ...
        'c_I_CCL2', 'c_M_CXCL5', 'c_I_CXCL5', 'c_K', 'c_MK', 'c_IK', 'c_MT', ...
